 ...
 * Brand: MAIA - Mapfre Inteligência Artificial
 */
...
export function AppHeader({
  ...
  return (
    <header className="flex h-14 items-center gap-4 border-b px-4 bg-primary/5">
      <div className="flex items-center gap-3 font-semibold">
        {/* MAIA Logo - Símbolo de proteção e inteligência */}
        <svg
          width="32"
          height="32"
          viewBox="0 0 805 805"
        ...
        >
          ...
          <defs>
            ...
            >
              {/* MAIA Azul Institucional #003366 → Ciano #00BCD4 */}
        ...
        <div className="flex flex-col">
          <span className="text-lg font-bold text-primary tracking-tight">MAIA</span>
          <span className="text-[10px] text-muted-foreground leading-none -mt-0.5">A inteligência que cuida</span>
        </div>
        {/* Mode Badge */}
        {oaiMode.enabled && (
