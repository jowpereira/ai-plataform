/**
 * About MAIA Modal - Mostra informações sobre a plataforma MAIA
 * MAIA - Mapfre Inteligência Artificial
 */
...
import { ExternalLink, Shield, Brain, Heart } from "lucide-react";
      ...
      <DialogContent className="max-w-md">
          ...
          <DialogTitle className="flex items-center gap-3">
            ...
            >
              <path
                ...
                fill="url(#paint0_about_maia)"
              />
              <defs>
                <linearGradient
                  id="paint0_about_maia"
                  x1="255.628"
                  y1="-34.3245"
                  x2="618.483"
                  y2="632.032"
            ...
            <div>
              <span className="text-xl font-bold text-primary">MAIA</span>
              <p className="text-xs text-muted-foreground font-normal">Mapfre Inteligência Artificial</p>
            </div>
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="px-6 pb-6 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-accent/10">
              <Shield className="h-5 w-5 text-accent" />
              <span className="text-xs text-muted-foreground">Confiável</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-accent/10">
              <Brain className="h-5 w-5 text-accent" />
              <span className="text-xs text-muted-foreground">Inovador</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-accent/10">
              <Heart className="h-5 w-5 text-accent" />
              <span className="text-xs text-muted-foreground">Empático</span>
            </div>
          </div>

          <p className="text-sm text-muted-foreground text-center">
            Plataforma de agentes inteligentes baseada no Microsoft Agent Framework, 
            desenvolvida para oferecer soluções de IA que cuidam de você.
          </p>
