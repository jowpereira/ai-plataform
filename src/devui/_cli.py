...
def create_cli_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="devui",
        description="Launch MAIA - Debug interface with OpenAI compatible API",
...
Examples:
  ...
  devui --tracing                   # Enable OpenTelemetry tracing
    ...
    parser.add_argument("--version", action="version", version=f"MAIA {get_version()}")
